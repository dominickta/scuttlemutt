...
import com.scuttlemutt.app.conversation.ConversationContent
import com.scuttlemutt.app.conversation.KeyboardShownKey
import com.scuttlemutt.app.conversation.LocalBackPressedDispatcher
import com.scuttlemutt.app.data.exampleUiStateComposers
    ...
    fun setUp() {
        ...
        composeTestRule.setContent {
            CompositionLocalProvider(
                ...
                JetchatTheme {
                    ConversationContent(
                        uiState = exampleUiStateComposers,
                        navigateToProfile = { },
                        onNavIconPressed = { }
                    )
                }
