...
public class MeshDaemon {
     ...
     */
    public MeshDaemon(final IOManager ioManager, final StorageManager storage, final String currentUser) {
     ...
     * @param recipient Who sent the message.
     * @param seqId     The sequence number for this message.
     */
    public void sendMessage(String contents, String recipient, Long seqId) {
