...
public class MuttIdentifier  {
    ...
    /**
     * Constructs a new MuttIdentifier.
     ...
     */
    public MuttIdentifier(final String userContact, final UUID scuttlemuttNetworkUUID, final String publicKey) {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof MuttIdentifier)) {
            return false;
        }
        return this.getUniqueId().equals(((MuttIdentifier) o).getUniqueId());
    }
